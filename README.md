...
###✅ Statistics section: Create the <Statistics> component, which would display statistics from the
passed props. For example, file downloads by type, website visits by users from different countries,
...
<FriendList friends={friends} />; </Code>
...
id - unique transaction identifier type - transaction type amount - transaction amount currency -
currency type
...
<TransactionHistory items={transactions} />; </Code>
